...
parser.add_argument('--noise', type=float, default=75, help='noise level')
...
parser.add_argument('--noise_test', type=float, default=0.0, help='specific noise of isotropic Gaussian blurs')
