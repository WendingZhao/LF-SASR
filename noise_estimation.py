...
if __name__ == '__main__':
    folder=r'F:\scientificresearch\superresolution\sr_lightfield\code\Data_for_dest\sig_3_noise_15'
    src_datasets = os.listdir(folder)
    src_datasets.sort()
    im = imread('../Data_for_dest/sig_3_noise_15/Dataset_HCI_new_Scene_bedroom.png')
    # im = imread('../Data_for_dest/Dataset_HCI_new_Scene_bedroom_sig_1.5_noise_15.png')
    # im = imread(r'F:\scientificresearch\superresolution\sr_lightfield\code\LF-SASR\input\EPFL_ISO_Chart_1__Decoded\view_01_01.png')
    # im = imread(r'F:\scientificresearch\superresolution\sr_lightfield\LFdecodetool\Results_saving_origin\IMG_0437\IMG_0437_center.bmp')
    im = img_as_float(im)

    noise_level = [0,5, 15, 20, 30, 40]
