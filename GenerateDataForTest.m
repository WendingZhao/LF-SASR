...
for DatasetIndex = 1 : length(Test_Dataset_List)
    ...
    for iScene = 1 : sceneNum
        ...
        sceneName(end-3:end) = [];
        fprintf('Generating test data of Scene_%s in Dataset %s......\t', sceneName, Tset_Dataset);
        ...
        fprintf([num2str(idx), ' test samples have been generated \n']);
    end
end
